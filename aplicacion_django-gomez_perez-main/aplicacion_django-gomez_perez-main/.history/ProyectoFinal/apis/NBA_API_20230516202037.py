...
def get_standings(season, conference=None):
    ...
    try:
        ...
        for rank in ranking:
            rank_dict = {
                "id": rank.get("team").get("id"),
                "name": rank.get("team").get("name"),
                "rank": rank.get("conference").get("rank"),
                "conference": rank.get("conference").get("name")
            }
            ranking_final.append(rank_dict)
